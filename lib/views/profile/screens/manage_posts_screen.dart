      ...
      body: GetBuilder<ManagePostsController>(
        builder: (controller) {
          return HandleViewStatus(
            ...
            widget: _BuildManagePostsScreen(controller: controller),
...
class _BuildManagePostsScreen extends StatelessWidget {
  const _BuildManagePostsScreen({
    Key? key,
    required this.controller,
  }) : super(key: key);

  final ManagePostsController controller;
