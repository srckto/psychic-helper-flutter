...
class ChatDetailsController extends GetxController {
  ...
  StreamSubscription<QuerySnapshot<Map<String, dynamic>>> getMessages({
  ...
  Future<void> deleteSingleMessage({required MessageModel model, required String receiveId}) async {
    try {
